...
@Log4j2
public class MeshedBody2 implements IMesh {
	...
	public MeshedBody2(List<Vector3d> tetVertices, IntList tetIndices, List<AttachedVertex> modelVertices, IntList modelIndices) {
